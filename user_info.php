...
if ($_POST['actt']=='user_info'){
    ...
    $school_id=ReStr($_POST['school_id']);
        ...
        <div class="userinput">
            <table width="850" border="0" align="center" cellpadding="0" cellspacing="0" >
                ...
                <tr>
                    ...
                    <td width="64" height="30" align="center">学校编号</td>
                    <td width="77" height="30" align="center">&nbsp;<input name="u_school_id" type="text"  value="<?php echo $row['u_school_id'] ?>"  id="u_school_id" size="10" maxlength="30">   </td>
