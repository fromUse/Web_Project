...
<tr height=107 style='mso-height-source:userset;border:0.0pt solid black;height:40.25pt'>
   <td colspan=10 height=25 class=xl109 width=727 style='height:45.75pt;border-right:0.0pt solid black;
...
<table width=727 border=1 align="center" cellpadding=0 cellspacing=1 style='border-collapse:
 ...
 <tr height=36 style='mso-height-source:userset;height:27.0pt'>
  <td height=36 class=xl81 width=51 style='height:27.0pt;width:38pt'>考生<br>姓名</td>
  ...
  <td class=xl65 width=56 style='border-left:none;width:42pt'>中职<br>学籍号</td>
 ...
 <tr height=40 style='mso-height-source:userset;height:30.0pt'>
  ...
  <td class=xl67 width=56 style='border-top:none;border-left:none;width:42pt'>出生<br>
    年月</td>
  <td class=xl72 width=95 style='border-top:none;border-left:none;width:71pt'><?php echo $u_birth?></td>
  <td class=xl67 width=56 style='border-top:none;border-left:none;width:42pt'>性别</td>
  <td class=xl72 width=104 style='border-top:none;border-left:none;width:78pt'><?php echo $u_sex?></td>
 </tr>
 <tr height=53 style='mso-height-source:userset;height:39.75pt'>
  <td height=53 class=xl82 width=51 style='height:39.75pt;width:38pt'>户口<br>所在地</td>
  ...
  <td class=xl67 width=56 style='border-top:none;border-left:none;width:42pt'>户籍<br>类型</td>
  <td class=xl79 width=72 style='border-top:none;border-left:none;width:78pt'><?php echo $u_huji?></td>
 </tr>
 <tr height=40 style='mso-height-source:userset;height:30.0pt'>
  ...
  <td class=xl67 width=51 style='border-top:none;width:38pt'>政治<br>面貌</td>
  <td colspan=2 class=xl72 width=140 style='border-left:none;width:105pt'><?php echo $u_zzmm?></td>
  <td class=xl67 width=95 style='border-top:none;width:71pt'>现就读<br>学校</td>
 ...
 <tr height=40 style='mso-height-source:userset;height:30.0pt'>
  ...
  width:38pt'>中职<br>
    专业</td>
  <td colspan=2 class=xl72 width=153 style='border-left:none;width:115pt'><?php echo $u_vocational?></td>
  <td class=xl67 width=84 style='border-top:none;border-left:none;width:63pt'>报考专业</td>
  <td colspan=2 class=xl72 width=151 style='border-left:none;width:113pt'><?php echo $u_applyfor?></td>
  <td class=xl67 width=56 style='border-top:none;border-left:none;width:42pt'>联系<br>
    电话</td>
  <td colspan=3 class=xl72 width=232 style='border-right:1.0pt solid black;
  border-left:none;width:274pt'><?php echo $u_tel?></td>
 </tr>
 <tr height=40 style='mso-height-source:userset;height:30.0pt'>
  <td height=40 class=xl82 width=51 style='height:30.0pt;border-top:none;
  width:38pt'>通信<br> 地址</td>
 ...
 <tr height=40 style='mso-height-source:userset;height:30.0pt'>
  ...
  <td class=xl67 width=48 style='border-top:none;border-left:none;width:36pt'>获奖<br>等级</td>
 ...
 <tr height=33 style='mso-height-source:userset;height:24.95pt'>
  ...
  width:38pt'>个<br>人<br>简<br>历</td>
 ...
 <tr height=33 style='mso-height-source:userset;height:24.95pt'>
  ...
  border-left:none;width:115pt'><?php echo $u_resume1_date_star;if ($u_resume1_date_star!='') echo "至";　?><br><?php echo $u_resume1_date_end?></td>
 ...
 <tr height=33 style='mso-height-source:userset;height:24.95pt'>
  <td colspan=2 height=33 class=xl70 width=153 style='height:24.95pt;
  border-left:none;width:115pt'><?php echo $u_resume2_date_star;if ($u_resume2_date_star!='') echo "至";?><br><?php echo $u_resume2_date_end?></td>
 ...
 <tr height=33 style='mso-height-source:userset;height:24.95pt'>
  <td colspan=2 height=33 class=xl70 width=153 style='height:24.95pt;
  border-left:none;width:115pt'><?php echo $u_resume3_date_star;if ($u_resume3_date_star!='') echo "至";?><br><?php echo $u_resume3_date_end?></td>
 ...
 <tr height=38 style='mso-height-source:userset;height:28.5pt'>
  ...
  height:103.35pt;width:38pt'>主要<br>家庭<br>成员</td>
 ...
 <tr height=33 style='mso-height-source:userset;height:24.95pt'>
  <td height=33 class=xl72 width=102 style='height:24.95pt;border-top:none;
  border-left:none;width:77pt'><?php echo $u_members1_name?></td>
  <td class=xl72 width=51 style='border-top:none;border-left:none;width:38pt'><?php echo $u_members1_relationship?></td>
  <td colspan=5 class=xl72 width=395 style='border-left:none;width:296pt'><?php echo $u_members1_work?></td>
  <td colspan=2 class=xl72 width=128 style='border-right:1.0pt solid black;
  border-left:none;width:96pt'><?php echo $u_members1_chief?></td>
 </tr>
 <tr height=33 style='mso-height-source:userset;height:24.95pt'>
  <td height=33 class=xl72 width=102 style='height:24.95pt;border-top:none;
  border-left:none;width:77pt'><?php echo $u_members2_name?></td>
  <td class=xl72 width=51 style='border-top:none;border-left:none;width:38pt'><?php echo $u_members2_relationship?></td>
  <td colspan=5 class=xl72 width=395 style='border-left:none;width:296pt'><?php echo $u_members2_work?></td>
  <td colspan=2 class=xl72 width=128 style='border-right:1.0pt solid black;
...
备注：<font class="font14"> </font><font class="font9"> 1.推荐意见栏中，若中职学校同意推荐，请批注：情况属实，同意推荐。<br>
    <span style='mso-spacerun:yes'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  </span>2.寄送的纸质报名材料：三二分段转段考核报名表、有效期内的二代身份证正反面复印件、户口本户主页及本人页复印件、中考录取或入学名册复印件，专业技能证书复印件，上述材料（除录取名册外）用A4纸打印或复印，由考生所在中职学校于6月2日前送（或寄）到我院招生办。<br>
    <span style='mso-spacerun:yes'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  </span>3.学院招生办联系方式：0660-3386864，地址：广东省汕尾市城区文德路汕尾职业技术学院招生办公室。</font></td>
 </tr>
