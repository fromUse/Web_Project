...
<a href="kaoshi_detail2.php?id=<?php echo $id ?>&page=1" target="_self">下两个</a>
<INPUT onclick=document.all.WebBrowser.ExecWB(6,1) value=打印 type=button> 
<INPUT onclick=document.all.WebBrowser.ExecWB(6,6) value=直接打印 type=button> 
<INPUT onclick=document.all.WebBrowser.ExecWB(8,1) value=页面设置 type=button> 
<INPUT onclick=document.all.WebBrowser.ExecWB(7,1) value=打印预览 type=button>&nbsp;
<INPUT onclick=javascript:window.close() value=关闭窗口 type=button> 
