...
if (mysql_num_rows($query)>0){
	...
	$u_resume1_date_star=$row['u_resume1_date_star'];
	$u_resume1_date_end=$row['u_resume1_date_end'];
	$u_resume1_content=$row['u_resume1_content'];
	$u_resume1_position=$row['u_resume1_position'];
	
	$u_resume2_date_star=$row['u_resume2_date_star'];
	$u_resume2_date_end=$row['u_resume2_date_end'];
	$u_resume2_content=$row['u_resume2_content'];
	$u_resume2_position=$row['u_resume2_position'];
	
	$u_resume3_date_star=$row['u_resume3_date_star'];
	$u_resume3_date_end=$row['u_resume3_date_end'];
...
<body>
<table width=727 border=0 align="center" cellpadding=0 cellspacing=0 style='border-collapse:
 ...
 <tr height=61 style='mso-height-source:userset;height:45.75pt'>
  <td colspan=10 height=61 class=xl109 width=727 style='height:45.75pt;
 ...
 <tr height=33 style='mso-height-source:userset;height:24.95pt'>
  ...
  border-left:none;width:77pt'>　<?php echo $u_members2_name?></td>
  <td class=xl76 width=51 style='border-top:none;border-left:none;width:38pt'>　<?php echo $u_members2_relationship?></td>
  <td colspan=5 class=xl76 width=395 style='border-left:none;width:296pt'>　<?php echo $u_members2_work?></td>
 ...
 <tr height=75 style='mso-height-source:userset;height:56.25pt'>
  ...
  style='mso-spacerun:yes'>&nbsp;
  </span>本人已仔细阅读《汕尾职业技术学院2015年对口中职学校自主招生三二分段转段考核工作方案》，符合报名条件，现郑重承诺：一、报名所提供的个人信息真实、准确、完整，不弄虚作假，不伪造和使用假证明、假证书，如因个人信息错误、失真、缺失造成不良后果，责任由本人承担。二、自觉服从考场工作人员和监考老师的管理，自觉遵守考试纪律和考场规则，考试诚实守信，不违规，不作弊。<br>
    <span
  style='mso-spacerun:yes'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 ...
 <tr height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  style='mso-spacerun:yes'>&nbsp;&nbsp; </span>日（学校盖章）<span
 ...
 <tr height=107 style='mso-height-source:userset;height:80.25pt'>
  <td colspan=10 height=107 class=xl87 width=727 style='height:80.25pt;
  width:545pt'>备注：<font class="font14"> </font><font class="font9">1.推荐意见栏中，若中职学校或单位同意见推荐，请批注：情况属实，同意推荐。<br>
    <span style='mso-spacerun:yes'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
